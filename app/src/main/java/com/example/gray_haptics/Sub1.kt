...
class Sub1 : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //画像表示
        val imageView: ImageView = findViewById(R.id.imageButton1)
        imageView.setImageResource(R.drawable.grid_100)//※

        //returnボタンで前画面に移動
        val returnButton = findViewById<Button>(R.id.return_main1)
    ...
    override fun onTouchEvent(event: MotionEvent): Boolean {
        ...
        return when (MotionEventCompat.getActionMasked(event)) {
            ...
            MotionEvent.ACTION_DOWN -> {
                ...
                //csvファイルから数値を配列に代入
                try {
                    val file = resources.assets.open(file1.toString())
