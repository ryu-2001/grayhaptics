...
class Sub4 : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imageView.setImageResource(R.drawable.grid_400)//※

        //returnボタンで前画面に移動
        val returnButton = findViewById<Button>(R.id.return_main4)
    ...
    override fun onTouchEvent(event: MotionEvent): Boolean {
        ...
        return when (MotionEventCompat.getActionMasked(event)) {
            ...
            MotionEvent.ACTION_DOWN -> {
                ...
                //csvファイルから数値を配列に代入
                try {
                    val file = resources.assets.open(file4.toString())
